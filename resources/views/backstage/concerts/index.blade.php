            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-section">
                        <div class="m-xs-b-4">
                            <div class="m-xs-b-2">
                                <h1 class="text-lg wt-bold">
                                    {{ $concert->title }}
                                </h1>
                                <p class="wt-medium text-dark-soft">
                                    {{ $concert->subtitle }}
                                </p>
                            </div>
                            <p class="text-sm m-xs-b-2">
                                @icon('location', 'zondicon-sm text-dark-soft
                                m-xs-r-1') {{ $concert->venue }} &ndash;
                                {{ $concert->city }}, {{ $concert->state }}
                            </p>
                            <p class="text-sm">
                                @icon('calendar', 'zondicon-sm text-dark-soft
                                m-xs-r-1') {{ $concert->formatted_date }} @
